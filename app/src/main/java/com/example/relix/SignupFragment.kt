...
import com.example.relix.EMAIL_ERROR_TEXT
import com.example.relix.MOB_ERROR_TEXT
import com.example.relix.R
import com.example.relix.databinding.FragmentSignupBinding
	...
	private fun setUpClickableLoginText() {
		...
		val clickableSpan = object : ClickableSpan() {
			override fun onClick(widget: View) {
				findNavController().navigate(R.id.action_signup_to_fragment_login)
			}
		}
