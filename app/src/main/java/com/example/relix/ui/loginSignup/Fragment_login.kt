package com.example.relix.ui.loginSignup
...
import com.example.relix.MOB_ERROR_TEXT
import com.example.relix.R
import com.example.relix.databinding.ActivityLoginBinding.inflate
import com.vishalgaur.shoppingapp.data.utils.LogInErrors
import com.vishalgaur.shoppingapp.ui.LoginViewErrors
import com.vishalgaur.shoppingapp.ui.loginSignup.LoginSignupBaseFragment


class fragment_login : Fragment() {

    override fun setViewBinding(): fragment_login {
        return fragment_login.inflate(layoutInflater)
    }
    ...
    override fun setUpViews() {
        ...
        binding.loginLoginBtn.setOnClickListener(object : LoginSignupBaseFragment.OnClickListener {
